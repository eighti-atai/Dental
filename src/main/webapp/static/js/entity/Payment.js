...
entityModule.factory('EntityService', ['$http', '$q', function($http, $q){
    ...
    var entityRec = {
        name   :'Payment',
        record :{id:{patientId:'', treatmentId:'', paymentNo:''},paymentDate:new Date(), paymentType:'',paymentMethod:'',amount:'',chequeNo:'',chequeExpDate:'',chequeBank:'',objid:null, selected:false},
    ...
    function emptyRecord() {
        return {id:{patientId:'', treatmentId:'', paymentNo:''},paymentDate:new Date(), paymentType:'',paymentMethod:'',amount:'', chequeNo:'',chequeExpDate:'',chequeBank:'',objid:null, selected:false};
    }	
}]);/**
 * 
 */